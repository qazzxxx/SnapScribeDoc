  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        text: '下载安装',
        items: [
          { text: 'Edge', link: 'https://microsoftedge.microsoft.com/addons/detail/acdgolljkjjpobjpjpenopfohjahoifl' },
          { text: 'chrome', link: 'https://chromewebstore.google.com/detail/neijkcnhjjjcglhahinmhigahannljno' }
        ]
      },
